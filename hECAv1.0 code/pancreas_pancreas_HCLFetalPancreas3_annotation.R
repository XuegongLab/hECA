...
datasetName = "pancreas_pancreas_HCLFetalPancreas3"
dataFormat = 'tsv'
setwd(paste0("D:/",datasetName,"/"))
dataobj<-readRDS("Fetal-Pancreas3.seuratobj.rds")
...
dataobj$hcad.label<-gsub("Acinar cell_CPA2 high","Pancreas-Epithelial tissue-Acinar cell-SPINK1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Dendritic cell_CPVL high","Pancreas-Connective tissue-Dendritic cell-CCL19",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Dendritic cell_HLA-DRA high","Pancreas-Connective tissue-Dendritic cell-CCL19",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Endocrine cell","Pancreas-Epithelial tissue-Endocrine cell-INS",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Endothelial cell_APLNR high","Pancreas-Epithelial tissue-Endothelial cell-PLVAP",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Endothelial cell_IGFBP3 high","Pancreas-Epithelial tissue-Endothelial cell-PLVAP",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Endothelial cell_PLVAP high","Pancreas-Epithelial tissue-Endothelial cell-PLVAP",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Erythroid cell_AHSP high","Pancreas-Connective tissue-Erythrocyte-HBG1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Erythroid cell_HBA1 high","Pancreas-Connective tissue-Erythrocyte-HBG1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Fibroblast","Pancreas-Connective tissue-Fibroblast-COL3A1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Follicular dendritic cell","Pancreas-Connective tissue-Dendritic cell-CCL19",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Lymphatic endothelial cell","Pancreas-Epithelial tissue-Endothelial cell-PLVAP",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Macrophage","Pancreas-Connective tissue-Macrophage-C1QA",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Mast cell","Pancreas-Connective tissue-Mast cell-RHEX",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Neuron","Pancreas-Nerve tissue-Neuron-GAL",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Neutrophil","Pancreas-Connective tissue-Neutrophilic granulocyte-S100A8",dataobj$hcad.label)
dataobj$hcad.label<-gsub("NK cell","Pancreas-Connective tissue-NK cell-NKG7",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Proliferating cell","Pancreas-Connective tissue-Proliferating T cell-UBE2C",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Smooth muscle cell","Pancreas-Muscle tissue-Smooth muscle cell-RGS5",dataobj$hcad.label)
dataobj$hcad.label<-gsub("T cell","Pancreas-Connective tissue-T cell-LTB",dataobj$hcad.label)
