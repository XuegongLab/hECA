...
datasetName = "Gallbladder_Gallbladder_HCLAdultGallbladder2"
dataFormat = 'tsv'
setwd(paste0("D:/",datasetName,"/"))
dataobj<-readRDS("Adult-Gallbladder2.seuratobj.rds")
...
dataobj$hcad.label<-gsub("Antigen presenting cell","Gallbladder-Connective tissue-Dendritic cell-FCER1A",dataobj$hcad.label)
dataobj$hcad.label<-gsub("B cell(Plasmocyte)","Gallbladder-Connective tissue-B cell-IGHM",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Dendritic cell","Gallbladder-Connective tissue-Dendritic cell-FCER1A",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Fibroblast","Gallbladder-Connective tissue-Fibroblast-CCDC80",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Lymphocyte","Gallbladder-Connective tissue-Lymphocyte-CCL3 CCL3L3",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Macrophage","Gallbladder-Connective tissue-Macrophage-C1QC",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Mucous epithelial cell","Gallbladder-Epithelial tissue-Epithelial cell-TM4SF4",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Neutrophil","Gallbladder-Connective tissue-Neutrophilic granulocyte-S100A8",dataobj$hcad.label)
dataobj$hcad.label<-gsub("T cell","Gallbladder-Connective tissue-T cell-IL32",dataobj$hcad.label)
dataobj$hcad.label<-gsub("T cell_CCL5 high","Gallbladder-Connective tissue-T cell-IL32",dataobj$hcad.label)
...
dataobj.dbupload_v1$donor_age<-"58yr"
