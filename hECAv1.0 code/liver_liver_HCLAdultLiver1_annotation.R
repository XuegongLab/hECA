...
datasetName = "liver_liver_HCLAdultLiver1"
dataFormat = 'tsv'
setwd(paste0("D:/",datasetName,"/"))
dataobj<-readRDS("Adult-Liver1.seuratobj.rds")
...
dataobj$hcad.label<-gsub("Activated T cell","Liver-Connective tissue-T cell-RPS27",dataobj$hcad.label)
dataobj$hcad.label<-gsub("B cell (Plasmocyte)_IGHM/HG high","Liver-Connective tissue-B cell-MZB1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Epithelial cell","Liver-Epithelial tissue-Epithelial cell-DEFB1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Hepatocyte_FGB high","Liver-Epithelial tissue-Hepatocyte-ORM2",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Hepatocyte_GSTA1 high","Liver-Epithelial tissue-Hepatocyte-ORM2",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Kuppfer cell","Liver-Connective tissue-Kuppfer cell-CD5L",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Macrophage","Liver-Connective tissue-Macrophage-HLA-DQA1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Mast cell","Liver-Connective tissue-Mast cell-TPSB2",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Motile liver macrophage","Liver-Connective tissue-Macrophage-HLA-DQA1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Myeloid cell","Liver-Connective tissue-Monocyte-VCAN",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Neutrophil_CD177 high","Liver-Connective tissue-Neutrophilic granulocyte-S100A8",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Neutrophil_ELANE high","Liver-Connective tissue-Neutrophilic granulocyte-S100A8",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Neutrophil_LCN2 high","Liver-Connective tissue-Neutrophilic granulocyte-S100A8",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Neutrophil_LTF high","Liver-Connective tissue-Neutrophilic granulocyte-S100A8",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Sinusoidal endothelial cell","Liver-Epithelial tissue-Endothelial cell-OIT3",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Vascular endothelial cell","Liver-Epithelial tissue-Endothelial cell-OIT3",dataobj$hcad.label)
...
dataobj.dbupload_v1$donor_age<-"21yr"
