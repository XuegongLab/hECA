...
datasetName = "pancreas_pancreas_HCLAdultPancreas1"
dataFormat = 'tsv'
setwd(paste0("D:/",datasetName,"/"))
dataobj<-readRDS("Adult-Pancreas1.seuratobj.rds")
...
dataobj$hcad.label<-gsub("Acinar cell_CPA1 high","Pancreas-Epithelial tissue-Acinar cell-CLPS",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Acinar cell_REG1B high","Pancreas-Epithelial tissue-Acinar cell-CLPS",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Acniar cell_ANXA4 high","Pancreas-Epithelial tissue-Acinar cell-CLPS",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Alpha cell","Pancreas-Epithelial tissue-Alpha cell-CHGB",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Beta cell","Pancreas-Epithelial tissue-Beta cell-SCG5",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Ductal cell","Pancreas-Epithelial tissue-Ductal cell-CXCL1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Endothelial cell","Pancreas-Epithelial tissue-Endothelial cell-SPARCL1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Exocrine cell","Pancreas-Epithelial tissue-Exocrine cell-REG3A",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Exocrine cell_SAA1 high","Pancreas-Epithelial tissue-Exocrine cell-REG3A",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Fibroblast","Pancreas-Connective tissue-Fibroblast-DCN",dataobj$hcad.label)
dataobj$hcad.label<-gsub("M2 Macrophage","Pancreas-Connective tissue-Macrophage-RGS1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Smooth muscle cell","Pancreas-Muscle tissue-Smooth muscle cell-ACTG1 HSPB1",dataobj$hcad.label)
...
dataobj.dbupload_v1$donor_id<-"AdultPancreas1"
dataobj.dbupload_v1$donor_gender<-"Female"
dataobj.dbupload_v1$donor_age<-"43yr"
