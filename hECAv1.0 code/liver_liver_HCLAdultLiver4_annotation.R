...
datasetName = "liver_liver_HCLAdultLiver4"
dataFormat = 'tsv'
setwd(paste0("D:/",datasetName,"/"))
dataobj<-readRDS("Adult-Liver4.seuratobj.rds")
...
dataobj$hcad.label<-gsub("Activated T cell","Liver-Connective tissue-T cell-XCL1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("B cell (Plasmocyte)_IGHA/HM_IGK high","Liver-Connective tissue-B cell-MZB1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("B cell (Plasmocyte)_IGHA/HM_IGL high","Liver-Connective tissue-B cell-MZB1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("B cell (Plasmocyte)_IGHG_IGK high","Liver-Connective tissue-B cell-MZB1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("B cell (Plasmocyte)_IGHG_IGL high","Liver-Connective tissue-B cell-MZB1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Conventional dendritic cell","Liver-Connective tissue-Dendritic cell-FCER1A",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Dendritic cell","Liver-Connective tissue-Dendritic cell-FCER1A",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Epithelial cell","Liver-Connective tissue-B cell-MZB1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Granulocyte","Liver-Connective tissue-Granulocyte-BPI",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Hepatocyte","Liver-Epithelial tissue-Hepatocyte-ADH1B",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Kuppfer Cell","Liver-Connective tissue-Kuppfer cell-CD5L",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Myeloid cell","Liver-Connective tissue-Monocyte-FCN1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Neutrophil","Liver-Connective tissue-Neutrophilic granulocyte-FCGR3B",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Proliferating cell","Liver-Connective tissue-B cell-MZB1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Sinusoidal endothelial cell","Liver-Epithelial tissue-Endothelial cell-DNASE1L3",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Sinusoidal endothelial cell_FCN1 high","Liver-Epithelial tissue-Endothelial cell-DNASE1L3",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Vascular endothelial cell","Liver-Epithelial tissue-Endothelial cell-DNASE1L3",dataobj$hcad.label)
