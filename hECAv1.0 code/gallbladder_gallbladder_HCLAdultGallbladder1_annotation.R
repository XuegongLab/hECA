...
datasetName = "Gallbladder_Gallbladder_HCLAdultGallbladder1"
dataFormat = 'tsv'
setwd(paste0("D:/",datasetName,"/"))
dataobj<-readRDS("Adult-Gallbladder1.seuratobj.rds")
...
dataobj$hcad.label<-gsub("Endothelial cell","Gallbladder-Epithelial tissue-Endothelial cell-FABP4",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Epithelial cell","Gallbladder-Epithelial tissue-Epithelial cell-REG1A",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Epithelial progenitor cell","Gallbladder-Epithelial tissue-Epithelial cell-REG1A",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Immune response stromal cell","Gallbladder-Connective tissue-Stromal cell-DCN",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Inflammatory stromal cell_HSPA1A high","Gallbladder-Connective tissue-Stromal cell-DCN",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Inflammatory stromal cell_MT-RNR2 high","Gallbladder-Connective tissue-Stromal cell-DCN",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Macrophage_CCL3L3 high","Gallbladder-Connective tissue-Macrophage-CTSB",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Macrophage_CTSB high","Gallbladder-Connective tissue-Macrophage-CTSB",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Macrophage_SDS high","Gallbladder-Connective tissue-Macrophage-CTSB",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Mast cell","Gallbladder-Connective tissue-Mast cell-TPSAB1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Mucous epithelial cell","Gallbladder-Epithelial tissue-Epithelial cell-REG1A",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Mucous epithelial cell_TFF1 high","Gallbladder-Epithelial tissue-Epithelial cell-REG1A",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Neutrophil","Gallbladder-Connective tissue-Neutrophilic granulocyte-S100A8",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Neutrophil_CXCL3 high","Gallbladder-Connective tissue-Neutrophilic granulocyte-S100A8",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Smooth muscle cell","Gallbladder-Muscle tissue-Smooth muscle cell-TAGLN",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Stromal cell_MFAP5 high","Gallbladder-Connective tissue-Stromal cell-DCN",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Stromal cell_PLA2G2A high","Gallbladder-Connective tissue-Stromal cell-DCN",dataobj$hcad.label)
dataobj$hcad.label<-gsub("T cell","Gallbladder-Connective tissue-T cell-CST7",dataobj$hcad.label)
...
dataobj.dbupload_v1$organ<-"Gallbladder"
...
dataobj.dbupload_v1$donor_age<-"45yr"
