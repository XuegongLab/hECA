...
datasetName = "liver_liver_HCLAdultLiver2"
dataFormat = 'tsv'
setwd(paste0("D:/",datasetName,"/"))
dataobj<-readRDS("Adult-Liver2.seuratobj.rds")
...
dataobj$hcad.label<-gsub("Activated T cell","Liver-Connective tissue-T cell-S100A4 XCL2",dataobj$hcad.label)
dataobj$hcad.label<-gsub("B cell (Plasmocyte)_IGHA/HM high","Liver-Connective tissue-B cell-MZB1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("B cell (Plasmocyte)_IGHG high","Liver-Connective tissue-B cell-MZB1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Conventional dendritic cell_FECER1A high","Liver-Connective tissue-B cell-CD74 CD52",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Dendritic cell","Liver-Connective tissue-B cell-CD74 CD52",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Epithelial cell","Liver-Epithelial tissue-Epithelial cell-KRT8",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Hepatocyte","Liver-Epithelial tissue-Hepatocyte-ORM1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Hepatocyte_HP high","Liver-Epithelial tissue-Hepatocyte-ORM1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Hepatocyte_TF high","Liver-Epithelial tissue-Hepatocyte-ORM1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Kuppfer Cell","Liver-Connective tissue-Kuppfer cell-C1QC",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Myeloid cell","Liver-Connective tissue-Monocyte-FCN1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Neutrophil","Liver-Connective tissue-Neutrophilic granulocyte-DEFA4",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Proliferating cell","Liver-Connective tissue-Proliferating T cell-UBE2C",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Sinusoidal endothelial cell","Liver-Epithelial tissue-Endothelial cell-DNASE1L3",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Smooth muscle cell","Liver-Muscle tissue-Smooth muscle cell-TAGLN",dataobj$hcad.label)
...
dataobj.dbupload_v1$donor_age<-"52yr"
