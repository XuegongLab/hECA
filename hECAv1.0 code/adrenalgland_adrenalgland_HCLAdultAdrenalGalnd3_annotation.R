...
datasetName = "adrenalgland_adrenalgland_HCLAdultAdrenalGland3"
dataFormat = 'tsv'
setwd(paste0("D:/",datasetName,"/"))
dataobj<-readRDS("Adult_AdrenalGland3.seuratobj.rds")
...
dataobj$hcad.label<-gsub("B cell(plasmocyte)","Adrenal gland-Connective tissue-Plasma B cell-IGHG4",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Endothelial cell_CCL2 high","Adrenal gland-Epithelial tissue-Endothelial cell-CCL2",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Endothelial cell_VWF high","Adrenal gland-Epithelial tissue-Endothelial cell-CCL2",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Intra-adrenal chromoblast","Adrenal gland-Epithelial tissue-Zona fasciculata cell-CYP17A1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("lymphatic endothelial cell","Adrenal gland-Epithelial tissue-Endothelial cell-CCL2",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Macrophage","Adrenal gland-Connective tissue-Macrophage-C1QB",dataobj$hcad.label)
dataobj$hcad.label<-gsub("MT high","Adrenal gland-Epithelial tissue-Zona fasciculata cell-CYP17A1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Neuron","Adrenal gland-Nerve tissue-Neuron-S100B",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Neutrophil","Adrenal gland-Connective tissue-Neutrophilic granulocyte-CCL20",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Smooth muscle cell_CCL4L2 high","Adrenal gland-Muscle tissue-Smooth muscle cell-TAGLN",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Smooth muscle cell_TAGLN high","Adrenal gland-Muscle tissue-Smooth muscle cell-TAGLN",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Stromal cell_APOD high","Adrenal gland-Connective tissue-Stromal cell-MGP IER2",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Unknown_CCL4 high","Adrenal gland-Epithelial tissue-Zona fasciculata cell-CYP17A1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Zona fasciculata cell_FDX1 high","Adrenal gland-Epithelial tissue-Zona fasciculata cell-CYP17A1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Zona fasciculata cell_GSTA1 high","Adrenal gland-Epithelial tissue-Zona fasciculata cell-CYP17A1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Zona fasciculata cell_HSD3B2 high","Adrenal gland-Epithelial tissue-Zona fasciculata cell-CYP17A1",dataobj$hcad.label)
dataobj$hcad.label<-gsub("Stromal cell_HES1 high","Adrenal gland-Connective tissue-Stromal cell-MGP IER2",dataobj$hcad.label)
...
dataobj.dbupload_v1$organ<-"Adrenal gland"
...
dataobj.dbupload_v1$donor_age<-"23yr"
